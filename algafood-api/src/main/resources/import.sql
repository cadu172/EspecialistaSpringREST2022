...
INSERT INTO algafood.grupo (id, nome) VALUES(1, 'ADMIN');
INSERT INTO algafood.grupo (id, nome) VALUES(2, 'SUPERVISOR');
INSERT INTO algafood.grupo (id, nome) VALUES(3, 'OPERACIONAL');


INSERT INTO algafood.grupo_permissao (grupo_id, permissao_id) VALUES (1, 1),(1, 2),(2, 2),(3, 3);
...
INSERT INTO algafood.restaurante (data_cadastro, data_atualizacao,id, taxa_frete, nome, cozinha_id, endereco_cidade_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero) VALUES(utc_timestamp,utc_timestamp,2, 25.00, 'MacDonalds',2, 6, 'Chacara Ondas Verdes','06715725','Casa 30','Estrada do Capuava','2451');
INSERT INTO algafood.restaurante (data_cadastro, data_atualizacao,id, taxa_frete, nome, cozinha_id, endereco_cidade_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero) VALUES(utc_timestamp,utc_timestamp,3, 25.00, 'Comida da Fazenda',3, 6, 'Chacara Ondas Verdes','06715725','Casa 30','Estrada do Capuava','2451');
INSERT INTO algafood.restaurante (data_cadastro, data_atualizacao,id, taxa_frete, nome, cozinha_id, endereco_cidade_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero) VALUES(utc_timestamp,utc_timestamp,4, 25.00, 'Bom Gosto',4, 6, 'Chacara Ondas Verdes','06715725','Casa 30','Estrada do Capuava','2451');
